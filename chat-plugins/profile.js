...
function Profile(isOnline, user, image) {
	...
	this.url = Config.avatarurl || 'http://52.25.253.73:8000';
}
...
Profile.prototype.dev = function () {
	if (typeof this.user === 'string' && developers.indexOf(toId(this.user)) > -1) return ' (<font color=#980000><b>Avalon Dev</b></font>)';
	if (this.user && developers.indexOf(this.user.userid) > -1) return ' (<font color=#980000><b>Avalon Dev</b></font>)';
	return '';
};
