...
function getShopDisplay(shop) {
	let display = '<center><b><font color="red" size="4">Read the description of the item you want to buy if you haven\'t already.</font></b></center></center><div style="box-shadow: 4px 4px 4px #000 inset, -4px -4px 4px #000 inset, 5px 3px 8px rgba(0, 0, 0, 0.6); max-height: 310px; overflow-y: scroll;"><table style="width: 100%; border-collapse: collapse;"><table style="width: 100%; border-collapse: collapse;"><tr><th colspan="3" class="table-header" style="background: -moz-linear-gradient(right, #00000, #00000); background: -webkit-linear-gradient(left, #000000, #00000); background: -o-linear-gradient(right, white, white); background: linear-gradient(right, white, white); padding: 8px 20px 16px 8px; box-shadow: 0px 0px 4px rgba(255, 255, 255, 0.8) inset; text-shadow: 1px 1px #0A2D43, 2px 2px #0A2D43, 3px 3px #0A2D43, 4px 4px #0A2D43, 5px 5px #0A2D43, 6px 6px #0A2D43, 7px 7px #0A2D43, 8px 8px #0A2D43, 9px 9px #0A2D43, 10px 10px #0A2D43;"><h2>Mists Shop</h2></th></tr>' +
		'<tr><th class="table-header" style="background: -moz-linear-gradient(#0000, #0000); background: -webkit-linear-gradient(#0000, #00000); background: -o-linear-gradient(#00000, #00000); background: linear-gradient(#0000, #00000); box-shadow: 0px 0px 4px rgba(255, 255, 255, 0.8) inset;">Item</th><th class="table-header" style="background: -moz-linear-gradient(#00000, #00000); background: -webkit-linear-gradient(#0000, #00000); background: -o-linear-gradient(#00000, #00000); background: linear-gradient(#00000, #00000); box-shadow: 0px 0px 4px rgba(255, 255, 255, 0.8) inset;">Description</th><th class="table-header" style="background: -moz-linear-gradient(#0000, #0000); background: -webkit-linear-gradient(#0000, #00000); background: -o-linear-gradient(#00000, #00000); background: linear-gradient(#00000, #00000); box-shadow: 0px 0px 4px rgba(255, 255, 255, 0.8) inset;">Cost</th></tr>';
	let start = 0;
...
*/
	...
	wallet: function (target, room, user) {
		...
		this.sendReplyBox('<b><font color="' + color(targetId) + '">' + Chat.escapeHTML(target) + '</font></b> has ' + amount + currencyName(amount) + '.');
	},
	...
	givemoney: function (target, room, user) {
		if (!(user.userid === 'rambo')) return this.sendReply('Sry you dont have auth to give money');
	    ...
	    Users.get(username).popup('|modal||html|<font color="red"><strong>ATTENTION!</strong></font><br /> You have received '+ amount +' from <b><font color="' + color(user.userid) + '">' + Chat.escapeHTML(user.name) + '</font></b> ' + 'you now have<font color=green> <b>' + total+ '</b></font>');

		//Users.get(username).popup('<b><font color="' + color(user.name) + '">' + Chat.escapeHTML(user.name) + '</font></b>has  give you'+ amount + '. you now have'+ total + '.');
	...
	takemoney: function (target, room, user) {
	    ...
	    Users.get(username).popup('|modal||html|<font color="red"><strong>ATTENTION!</strong></font><br /> <b><font color="' + color(user.userid) + '">' + Chat.escapeHTML(user.name) + '</font></b> has taken '+ amount + ' ' + 'from you .You now have<font color=green> <b>' + total+ '</b></font>');
